...
Theorem msfs_appendix_A_categorical_preliminaries_full : Prop.
Admitted.
...
Theorem msfs_corollary_grade_collapse : Prop.
Proof. exact msfs_proposition_grading_structural. Qed.

(* theorem — msfs — MSFS Proposition 2.2 (iv) — L_Abs == ∅ :: src/theorems/msfs/strata.vr *)
Theorem msfs_proposition_2_2_iv_l_abs_empty : Prop.
Proof. exact msfs_corollary_5_2_l_abs_empty. Qed.

(* theorem — msfs — MSFS Proposition 2.3 corollary — Cls(L_Fnd) ≠ L_Abs :: src/theorems/msfs/strata.vr *)
Theorem msfs_proposition_2_3_corollary_cls_not_in_l_abs : Prop.
Proof. exact msfs_proposition_2_2_iv_l_abs_empty. Qed.

(* theorem — msfs — MSFS Proposition 2.2 (iii) — L_Cls_top ⊋ L_Abs (vacuous form) :: src/theorems/msfs/strata.vr *)
Theorem msfs_proposition_2_2_iii_clsmax_strict_above_abs : Prop.
Proof. exact msfs_proposition_2_2_iv_l_abs_empty. Qed.

(* theorem — msfs — MSFS Proposition 2.2 (iii) — L_Fnd ⊋ L_Cls :: src/theorems/msfs/strata.vr *)
Theorem msfs_proposition_2_2_iii_fnd_strict_above_cls : Prop.
(* via msfs_proper_inclusion_fnd_cls — forward reference at statement level *)
Admitted.

(* theorem — msfs — MSFS Proposition 2.2 (iii) — L_Cls ⊋ L_Cls_top :: src/theorems/msfs/strata.vr *)
Theorem msfs_proposition_2_2_iii_cls_strict_above_clsmax : Prop.
(* via msfs_proper_inclusion_cls_clsmax — forward reference at statement level *)
Admitted.

(* theorem — msfs — MSFS Proposition 2.2 (iii) — L_Cls_top ⊋ L_Abs (typed-witness form) :: src/theorems/msfs/strata.vr *)
Theorem msfs_proposition_2_2_iii_clsmax_strict_above_abs_witness : Prop.
(* via msfs_proper_inclusion_clsmax_abs — forward reference at statement level *)
Admitted.
...
Theorem msfs_theorem_6_1_colim_in_s_s_global : Prop.
Admitted.
